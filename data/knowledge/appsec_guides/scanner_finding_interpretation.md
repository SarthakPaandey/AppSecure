...
3. **Severity is a prioritization signal**, not a full risk assessment. Context (authz boundaries, data sensitivity, internet exposure) still matters for fintech APIs.
